...
@main
struct JackBridgeGUIApp: App {
    @StateObject private var viewModel = JackBridgeViewModel()
    ...
    var body: some Scene {
        ...
        Window("About JackBridge", id: "about") {
            AboutView()
        }
        .windowResizability(.contentSize)
        .defaultPosition(.center)
...
class AppDelegate: NSObject, NSApplicationDelegate {
    static var viewModel: JackBridgeViewModel?
    ...
    @objc func openAbout() {
        openWindow(title: "About JackBridge", size: NSSize(width: 400, height: 350)) {
            AboutView()
        }
    }
